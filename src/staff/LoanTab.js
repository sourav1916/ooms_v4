...
const LoanTab = ({ loan, setLoan, variants }) => {
    return (
        <motion.div
            variants={variants}
            initial="initial"
        ...
        >
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Loan Report</h3>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        ...
                        <tr className="bg-gray-50 font-medium">
                            ...
                            <td className="px-6 py-3 text-sm text-gray-900">₹{loan.openingBalance}</td>
                            <td className="px-6 py-3 text-sm text-gray-900">₹0.00</td>
                            <td className="px-6 py-3 text-sm text-gray-900">₹{loan.openingBalance}</td>
                        </tr>

                        {/* Entries */}
                        {loan.entries.map((entry, index) => (
                        ...
                        <tr className="bg-gray-50 font-medium">
                            ...
                            <td className="px-6 py-3 text-sm text-gray-900">₹{loan.totalDebit}</td>
                            <td className="px-6 py-3 text-sm text-gray-900">₹{loan.totalCredit}</td>
                            <td className="px-6 py-3 text-sm text-gray-900">₹{loan.closingBalance}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
