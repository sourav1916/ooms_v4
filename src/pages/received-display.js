...
import { FiSearch, FiPlus, FiEdit, FiFileText, FiMenu, FiPrinter, FiMail, FiMessageSquare } from 'react-icons/fi';
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden min-h-0">
                                ...
                                <div className="border-b border-slate-200 shrink-0">
                                    <table className="w-full text-sm">
                                        <thead className="bg-gradient-to-r from-slate-50 to-slate-100">
                                            <tr>
                                                <th className="text-left p-4 font-semibold text-slate-700 whitespace-nowrap">Sl</th>
                                                <th className="text-left p-4 font-semibold text-slate-700 whitespace-nowrap">Date</th>
                                                <th className="text-left p-4 font-semibold text-slate-700 whitespace-nowrap">Particulars</th>
                                                <th className="text-left p-4 font-semibold text-slate-700 whitespace-nowrap">Voucher No</th>
                                                <th className="text-right p-4 font-semibold text-slate-700 whitespace-nowrap">Amount</th>
                                                <th className="text-left p-4 font-semibold text-slate-700 whitespace-nowrap">Received At</th>
                                                <th className="text-left p-4 font-semibold text-slate-700 whitespace-nowrap">Received By</th>
                                                <th className="text-center p-4 font-semibold text-slate-700 whitespace-nowrap">Actions</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                                            ...
                                            {received.length === 0 ? (
                                                <tr>
                                                    <td colSpan="8" className="text-center py-8 text-slate-500">
                                                        <div className="flex flex-col items-center justify-center">
                                                            ...
                                                            <p className="text-slate-500">No received records found</p>
                                                            <motion.button
                                                                onClick={() => setPaymentReceivedModal(true)}
                                                ...
                                                received.map((item, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <td className="p-4 text-slate-600 font-medium whitespace-nowrap">{index + 1}</td>
                                                            ...
                                                            <td className="p-4">
                                                                <div className="text-slate-800">
                                                                    {item.received_bank}
                                                                    <span className="text-blue-600 text-xs font-normal ml-2 bg-blue-50 px-2 py-1 rounded-full">
                                                                        {item.received_bank_type.toUpperCase()}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            <td className="p-4">
                                ...
                                <div className="border-t border-slate-200 bg-gradient-to-r from-slate-50 to-slate-100 shrink-0">
                                    <table className="w-full text-sm">
                                        <tfoot>
                                            <tr>
                                                <td className="text-right p-4 font-bold text-slate-800 whitespace-nowrap" colSpan="4">
                                                    Total
                                                </td>
