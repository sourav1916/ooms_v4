                                    ...
                                    <table className="w-full text-sm">
                                        <thead className="bg-gradient-to-r from-slate-50 to-slate-100">
                                            <tr>
                                                ...
                                                <th className="text-left p-4 font-semibold text-slate-700">Invoice No</th>
                                                <th className="text-left p-4 font-semibold text-slate-700">Party Name</th>
                                                <th className="text-left p-4 font-semibold text-slate-700">Party Type</th>
                                                <th className="text-right p-4 font-semibold text-slate-700">Original Amount</th>
                                                <th className="text-right p-4 font-semibold text-slate-700">Discount Amount</th>
                                                <th className="text-center p-4 font-semibold text-slate-700">Date</th>
                                                ...
                                                <tr>
                                                    <td colSpan="8" className="text-center py-8 text-slate-500">
                                                        <div className="flex flex-col items-center justify-center">
                                                            ...
                                                            <p className="text-slate-500">No discount vouchers found</p>
                                                            <motion.button 
                                                                onClick={() => setShowAddVoucherModal(true)}
                                                        ...
                                                        >
                                                            ...
                                                            <td className="p-4">
                                                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                                                                    ...
                                                                    {voucher.party_type.charAt(0).toUpperCase() + voucher.party_type.slice(1)}
                                                                </span>
                                                            </td>
                                                            <td className="p-4 text-right">
