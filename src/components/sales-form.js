            ...
            <div className="flex-1 overflow-y-auto p-6">
                <form onSubmit={handleSubmit}>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider hidden">Amount</th>
                                    ...
                                    {formData.items.map((item, index) => {
                                        ...
                                        return (
                                            <tr key={index} className="hover:bg-gray-50 transition-colors">
                                                    ...
                                                    >
                                                        ...
                                                        {serviceOptions.map(service => (
                                                            <option key={service.service_id} value={service.service_id}>
                                                                {service.name} - {formatCurrency(service.fees)} ({service.category})
                                                            </option>
                                                        ))}
                                                    </select>
                                                </td>
                                                ...
                                                <td className="px-4 py-3 text-right font-semibold text-gray-900 hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        {/* Discount Section */}
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <h4 className="text-md font-semibold text-gray-900 mb-3">Discount Settings</h4>
                            <div className="space-y-3">
                                <div>
