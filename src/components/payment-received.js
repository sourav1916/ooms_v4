        ...
        <div className="bg-white rounded-xl shadow-2xl flex flex-col h-full border border-gray-300">
            ...
            <div className="flex-shrink-0 flex items-center justify-between p-3 border-b border-gray-300 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-xl">
                ...
                {mode === 'modal' && (
                    <button
                        onClick={onClose}
                        className="text-blue-200 hover:text-white p-2 rounded-lg bg-blue-500 hover:bg-blue-600 transition-colors"
                    >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="number"
                                    className="pl-10 w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-colors"
                                    name="amount"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    className="pl-10 w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400 transition-colors appearance-none bg-white"
                                    required
                                >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full lg:w-auto">
                        ...
                        <div className="flex space-x-3">
                            ...
                            <button
                                ...
                                className="px-8 py-3 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
                            >
                                {isSubmitting ? (
                                    <>
                                    ...
                                    `Receive Payment - ${formData.amount ? `₹${Number(formData.amount).toLocaleString('en-IN')}` : '0.00'}`
                                )}
                            </button>
                        </div>
                    </div>
